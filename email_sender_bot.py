...
engine.setProperty('rate',180) #rate of speed at which the bot will speak to me
...
def listen(): 
    ...
    try:
        print("Recognizing.....")
        query = r.recognize_google(audio, language = 'en-in') #calling google api to recognise  my voice 
